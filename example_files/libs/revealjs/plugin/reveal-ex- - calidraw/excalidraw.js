window.RevealExcalidraw = function () {
  ...
  return {
    ...
    init: function (deck) {
      ...
      // Create a container for Excalidraw
      ...
      // Create a button to toggle Excalidraw visibility
      const toggleButton = document.createElement('button');
      toggleButton.textContent = 'Toggle Excalidraw';
      ...
      // define the Excalidraw component from the Excalidraw library for excalidrawContainer
      // ReactDOM.render("<Excalidraw />", excalidrawContainer);
      const App = () => {
